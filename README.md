...
This repository contains the implementation of COVE, introduced in the NAACL 2025 paper: ["COVE: COntext and VEracity prediction for out-of-context images](add_url). The code is released under an **Apache 2.0** license.
